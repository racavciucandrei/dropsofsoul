...
// The Maiz à Trois cocktail that's having image issues
export const maizATroisCocktail: CocktailData = {
  ...
  // Direct link to the image in public folder with absolute path
  imagePath: '/lovable-uploads/0d0bdbcb-f301-475f-bbbc-33e40d2d9fef.png'
};

// More cocktail data can be added here for reuse across the app
